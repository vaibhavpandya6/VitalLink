...
const SignInForm = ({ onBack, onSignInSuccess }) => {
  ...
  const getInputIcon = () => {
    ...
    if (isEmail) return <Mail className="w-5 h-5 text-gray-900" />;
    if (isPhone) return <Phone className="w-5 h-5 text-gray-900" />;
      ...
      <div className="w-full flex items-center justify-center px-4 py-12">
        <div className="bg-white rounded-2xl shadow-lg p-8 w-full max-w-md">
          ...
          <div className="text-center mb-8">
            ...
            <p className="text-gray-600 text-sm">Sign in to your VitalLink account</p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className={`w-full pl-10 pr-4 py-3 border rounded-lg focus:outline-none focus:ring-2 focus:ring-black focus:border-transparent transition-all text-gray-900 ${
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  onChange={handleInputChange}
                  className={`w-full pl-10 pr-12 py-3 border rounded-lg focus:outline-none focus:ring-2 focus:ring-black focus:border-transparent transition-all text-gray-900 ${
            ...
            <button
              type="submit"
              className="w-full bg-black text-white py-3 rounded-lg hover:bg-gray-900 transition-colors font-medium mt-6"
            >
              Sign In
            </button>
            ...
            <button
              type="button"
              className="w-full border border-gray-900 text-gray-900 py-3 rounded-lg hover:bg-gray-50 transition-colors font-medium"
            >
              Create New Account
            </button>
          </form>
