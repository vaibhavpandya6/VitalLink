...
const HospitalRegistrationForm = ({ onBack, onSignIn }) => {
    ...
    switch (name) {
      ...
      case 'establishmentYear':
        ...
        if (!/^\d{4}$/.test(value) && value !== '') {
          newErrors[name] = 'Enter a valid 4-digit year';
  ...
  const validateStep = (step) => {
    const stepFields = {
      ...
      6: ['hospitalLicense', 'registrationCertificate', 'password', 'confirmPassword', 'emergencyContactPerson', 'termsAccepted', 'privacyAccepted']
    };
    ...
    if (step === 4 && formData.bloodBankFacility === 'yes') {
      if (!formData.storageCapacity) {
        newErrors.storageCapacity = 'Storage capacity is required for blood banks';
        isValid = false;
      }
        ...
        <div className="bg-white rounded-2xl shadow-2xl p-8 max-w-lg w-full text-center">
          ...
          <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-4 mb-6">
            ...
            <p className="text-yellow-700 text-sm">
              Your hospital registration is currently under manual verification by our team. 
          ...
          <div className="space-y-3">
            <div className="text-sm text-gray-500">
              <strong>Reference ID:</strong> HSP-{Math.random().toString(36).substr(2, 9).toUpperCase()}
            </div>
            <button
              onClick={onSignIn}
          ...
          <div className="space-y-6">
            ...
            <div>
              ...
              <input
                ...
                placeholder="Person to contact for critical requests"
              />
              {errors.emergencyContactPerson && <p className="text-red-500 text-sm mt-1">{errors.emergencyContactPerson}</p>}
            </div>

            <div className="bg-gray-50 border border-gray-200 rounded-lg p-4 space-y-4">
              <h4 className="font-semibold text-gray-800">Accreditations (Optional)</h4>
              ...
              <div>
                ...
                <div className="relative">
                  <input
                    ...
                    onChange={handleInputChange}
                    className={`w-full p-3 border rounded-lg focus:ring-2 focus:ring-red-500 focus:border-transparent pr-12 ${
              ...
              <div className="flex items-start space-x-3">
                ...
                <div>
                  ...
                  <p className="text-yellow-700 text-sm mt-1">
                    ...
                    The verification process typically takes 2-5 business days. You'll receive email 
            ...
            <div className="space-y-3">
              <label className="flex items-start space-x-3">
                ...
                <span className="text-sm text-gray-600">
                  I agree to VitalLink's{' '}
                  <a href="#" className="text-red-600 hover:underline">Terms of Service</a> and confirm that all provided information is accurate and complete. *
                </span>
              </label>
              ...
              <label className="flex items-start space-x-3">
                ...
                />
                <span className="text-sm text-gray-600">
                  I acknowledge and accept VitalLink's{' '}
                  <a href="#" className="text-red-600 hover:underline">Privacy Policy</a> regarding the handling of hospital and patient data. *
                </span>
              </label>
            ...
            <div className="ml-auto">
              {currentStep < 6 ? (
                ...
                <div className="space-x-4">
                  <button
                    onClick={() => {
                      alert('Registration details reviewed. Ready to submit for verification!');
                    }}
...
export default HospitalRegistrationForm;="Blood storage capacity"
                    />
